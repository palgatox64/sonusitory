...
urlpatterns = [
    ...
    path('reorder-playlist/<int:playlist_id>/', views.reorder_playlist, name='reorder_playlist'),
    path('remove-from-playlist/<int:playlist_id>/<str:song_id>/', views.remove_from_playlist, name='remove_from_playlist'),
